      ...
      <tbody>
        <tr v-for="record in records" :key="record.record.id">
          <td style="text-align: left;">
            ...
            &nbsp;
            <span class="record-user-username">{{ record.a_rank }}</span>
            <span class="record-user-username">{{ "(" + record.a_rating + ")" }}</span>
          </td>
          <td style="text-align: left;">
            ...
            &nbsp;
            <span class="record-user-username">{{ record.b_rank }}</span>
            <span class="record-user-username">{{ "(" + record.b_rating + ")" }}</span>
          </td>
          <td>
            {{ record.result }}
          </td>
